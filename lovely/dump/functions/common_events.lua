LOVELY_INTEGRITY = '9faa9047ea436f567f5b1187b4500d03f48391c51399b772d7f2c4e37cd4017b'
...
function ease_ante(mod)
    G.E_MANAGER:add_event(Event({
      ...
      func = function()
          ...
          G.GAME.round_resets.ante = Big and (to_big(G.GAME.round_resets.ante):floor():to_number()) or math.floor(G.GAME.round_resets.ante)
...
function level_up_hand(card, hand, instant, amount)
    ...
    G.GAME.hands[hand].chips = math.max(G.GAME.hands[hand].chips + G.GAME.hands[hand].l_chips*amount, 1)
        ...
        for i = 1, #G.jokers.cards do
            local effects = G.jokers.cards[i]:calculate_joker({cry_universum = true})
                ...
                for z=1, #rep_list do
                    if type(rep_list[z]) == 'table' and rep_list[z].repetitions then
                        for r=1, rep_list[z].repetitions do
                            ...
                            local ef = G.jokers.cards[i]:calculate_joker({cry_universum = true})
                            universum_mod = universum_mod * (ef and ef.mod or 1)
                        end
                    end
                end
            end
...
function card_eval_status_text(card, eval_type, amt, percent, dir, extra)
    ...
    elseif eval_type == 'extra' or eval_type == 'jokers' then 
        sound = extra.edition and 'foil2' or extra.mult_mod and 'multhit1' or extra.Xmult_mod and 'multhit2' or extra.Xchip_mod and 'cry_Xchip' or extra.pow_mult_mod and 'cry_^Mult' or 'generic1'
...
function check_for_unlock(args)
    ...
    while i <= #G.P_LOCKED do
        ...
        if not custom_check and not card.unlocked and card.unlock_condition and args.type == 'career_stat' then
