LOVELY_INTEGRITY = 'f440990edccf2247b5ca952c465613f153d7982335089a6c61d1c19de8653fef'
...
function modulate_sound(dt)
  ...
  local desired_track =  
        ...
        (next(find_joker('cry-Jimball')) and Cryptid_config.Cryptid.jimball_music and 'cry_music-Jimball') or
...
function set_deck_win()
  if G.GAME.selected_back and G.GAME.selected_back.effect and G.GAME.selected_back.effect.center and G.GAME.selected_back.effect.center.key then
    ...
    if G.PROFILES[G.SETTINGS.profile].deck_usage[deck_key] then
      ...
      (G.P_STAKES["stake_"..G.P_CENTER_POOLS["Stake"][G.GAME.stake].unlocked_stake].stake_level-1) or (G.GAME.stake-1)
      do
...
function loc_colour(_c, _default)
  G.ARGS.LOC_COLOURS = G.ARGS.LOC_COLOURS or {
    ...
    cry_exotic = G.C.RARITY['cry_exotic'], cry_epic = G.C.RARITY['cry_epic'], cry_azure = HEX('1d4fd7'), heart = G.C.SUITS.Hearts, diamond = G.C.SUITS.Diamonds, spade = G.C.SUITS.Spades, club = G.C.SUITS.Clubs,
