LOVELY_INTEGRITY = 'a9b091eddf78f068b191bd69e63c3b8d6602368ff210bac3afeb2dc41bc928c5'
...
G.FUNCS.hand_text_UI_set = function(e)
  ...
  G.FUNCS.can_play = function(e)
    if #G.hand.highlighted <= (G.GAME.blind and G.GAME.blind.name == 'cry-Sapphire Stamp' and 1 or 0) or G.GAME.blind.block_play then
        e.config.colour = G.C.UI.BACKGROUND_INACTIVE
        e.config.button = nil
    else
        e.config.colour = G.C.BLUE
