LOVELY_INTEGRITY = 'b7262bed1ee52efef32b13ffeb55cd3452c7e4855f91c5bde7a3296d345dfefe'
...
function Back:trigger_effect(args)
    ...
    if (self.name == 'Anaglyph Deck' or self.name == 'cry-Antimatter') and args.context == 'eval' and G.GAME.last_blind and G.GAME.last_blind.boss then
